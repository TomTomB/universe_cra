import {
  ...
  Scheduler,
  loadImages,
} from '@universe/renderer/uikit/webgl';
import { EventEmitter } from '@universe/renderer/uikit/core';
...
import type { GlTextureSource, Size } from '@universe/renderer/uikit/webgl';
